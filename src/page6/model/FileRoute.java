...
public class FileRoute {
	...
	public static final String PATH_RAW = "src/page6/raw";
	public static final String PATH_DATA = "src/page6/data"; 
	...
	public static final String IMAGE_ROOT  = "src/page6/image/";
