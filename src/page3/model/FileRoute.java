...
public class FileRoute {
	...
	public static final String PATH_RAW = "src/page3/raw";
	public static final String PATH_DATA = "src/page3/data";
	...
	public static final String IMAGE_ROOT  = "src/page3/image/";
