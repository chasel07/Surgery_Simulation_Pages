...
public class FileRoute {
	...
	public static final String PATH_RAW = "src/page5/raw";
	public static final String PATH_DATA = "src/page5/data"; 
	public static final String PATH_COLOR_TABLE = PATH_DATA + "/colorTable.txt";
	...
	public static final String IMAGE_ROOT  = "src/page5/image/";
