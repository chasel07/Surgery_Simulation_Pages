...
import page5.view.MenuBar;
import page5.view.Page5_loadScriptPanel;
...
public class Main {
	...
	public static void initialFrame() throws IOException, ParseException {
		...
		File filepath = OpenFile(FILE_TYPE, COMMENT, FileRoute.PATH_SCRIPT);
		
		if(filepath != null)
			JP_SHOW.add(new Page5_loadScriptPanel(filepath, false), BorderLayout.CENTER);
	}
